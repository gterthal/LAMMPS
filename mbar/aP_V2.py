...
U_index = 5
V_index = 4
prop_index = 4    # sera usado ET para o calculo de CP a partir de H = ET + PV
...
for ind in range(K):
	...
	for (i,line) in enumerate(lines):
		...
		A_kn[ind,n[ind]] = float(elements[prop_index])*float(elements[prop_index])
		n[ind] += 1
...
numpy.savetxt('resultV2.txt', A_curve)
numpy.savetxt('resultV2_25.txt', Var)
numpy.savetxt('resultV2_20.txt', EA_k)
numpy.savetxt('result_sigmaV2.txt', dEA_k)
